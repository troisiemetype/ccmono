...
//	Serial.println(senseValue);
	...
	if(sense1.isJustProx()) lStatus.setLed(32);
	if(sense1.isJustProxReleased()) lStatus.clrLed(32);
	if(sense1.isJustTouched()) lStatus.setLed(33);
	if(sense1.isJustTouchedReleased()) lStatus.clrLed(33);

	if(sense1.isJustTouched()){
		Serial.println("Reading file...");
		File file;
		if(file = sd.open("essai.txt")){
			Serial.println("essai.txt");
			Serial.println();
